...
class TopBar extends React.Component {
  ...
  handleUploadButtonClicked = e => {
    ...
    if (!this.state.specifyPermissions) {
      let newUsersChecked = {}
      this.state.otherUsers.forEach(({ _id}) => {
          newUsersChecked[_id] = true;
      });
      this.setState({usersChecked: newUsersChecked}, 
            () => this.uploadForm(e));
    } else {
      this.uploadForm(e);
    }
  ...
  uploadForm = (e) => {
    //console.log(this.state.usersChecked);
                          ...
                          <FormControlLabel
                            control={
                              <Checkbox
                                ...
                                value={this.state.specifyPermissions}
                              />
                            }
